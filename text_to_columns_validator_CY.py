...
truth_record = {
    ...
    "carrier_mc":               "3723304",          # USDOT number listed on document
    "carrier_phone":            "ANONYMOUS DATA",   
    "carrier_fax":              "ANONYMOUS DATA",   
    "carrier_contact":          "ANONYMOUS DATA",   # Named in Terms & Conditions section
    ...
    "pickup_end_datetime_1":    "2023-07-25T13:00:00",  # Single time window given
